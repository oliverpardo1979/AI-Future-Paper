...
If \(\sigma_{HM}>1\), the result just established that \(s_M\to1\). Then \(E\) is asymptotically proportional
to \(AM\), giving
\[
 g_E=g_A+g_M=n+(1+\nu)g_A.
\]
...
condition makes \(qA/Y\) constant and gives \(g_q=g_Y-g_A\). The capability law implies
\(g_E=g_A/\eta\), and the positive limiting employment share \(L/N\) gives
...
The research CES has the exact envelope identity
\[
