...
\(1.6\times10^{-7}\). The reported transition is therefore insensitive to the
finite terminal date at the displayed precision.
...
toward the household discount rate and then rises with output-per-capita growth.
This comovement is required by the Euler equation: along a balanced-growth limit,
\(r=\rho+g_{C/N}\). The two research technologies produce similar returns early
