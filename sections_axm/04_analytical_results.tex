...
interior path satisfies the static first- and second-order conditions, market
clearing, and the canonical differential equations on its maximal time interval.
...
Within that branch, the model delivers a sharp separation when
