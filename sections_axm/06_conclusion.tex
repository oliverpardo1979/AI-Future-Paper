...
whether a falling service price makes automated research asymptotically dominant.
...
along a conventional balanced path. At unit elasticity, balanced-growth
candidates exist only when decreasing returns to effective research dominate the
combined effect of capability on inference and automated research. With gross
substitution, unbounded capability makes \(Y/K\) and the return to capital
...
\(M\) from \(AM\) makes this transition visible.
