...
\begin{enumerate}[label=(\roman*)]
    ...
    identities. The five paths satisfy them. Conditional
    ...
    condition.
    \item The $\sigma_{XL}=1$ path approaches the rates in conditional
    ...
    postulated shadow-value comparison. The five equilibrium computations do not
