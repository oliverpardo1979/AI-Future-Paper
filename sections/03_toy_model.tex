...
\begin{align}
    ...
    &=
    \left[
        \omega_L L_{Y,t}^{(\sigma_{XL}-1)/\sigma_{XL}}
...
\begin{align}
    g_A^{\mathrm{CD}}
    &=
    \frac{\eta n}{1-\phi-\eta\omega_M\upsilon},
    \label{eq:full-cd-ga}\\
    \gamma^{\mathrm{CD}}
    &=
    \frac{\upsilon\eta n}{1-\phi-\eta\omega_M\upsilon}.
...
\begin{equation}
    ...
    \frac{\xi M_t}{Y_t}
    =
    \frac{\beta^2\eta\omega_M g_A^{\mathrm{CD}}}
