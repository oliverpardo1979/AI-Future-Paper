\section{Baseline model and analytical results}
\label{sec:toy}
...
This subsection states the analytical results before introducing numerical
evidence. Propositions report results established from the model's equations
...
closure. The proofs of the propositions are collected in the appendix. The
equilibrium simulations in Section~\ref{sec:numerical} subsequently show how the
relevant mechanisms interact during the transition; they are not used to prove the
analytical claims.
...
\begin{proposition}[\citealp{yango2026}, Lemma~4.1 and Proposition~4.2]
...
\begin{conditionalresult}[Growth classification in the reduced allocation system]
