...
The proof is in Appendix~\ref{sec:appendix-proofs}. The first result differs from the
fixed-research-share closure used in Section~\ref{sec:numerical}. Holding $H/N$ and
...
general existence theorem. Existence still requires the level first-order
conditions, transversality, a feasible labor allocation, and $C/Y>0$.
