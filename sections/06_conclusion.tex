...
benchmark, the AI-dominated constant-growth candidate has a positive finite
capability-growth rate only if
$1-\phi-\eta\beta/(1-\alpha-\beta)>0$. If this condition fails, the candidate cannot
have a positive finite capability-growth rate. These statements are necessary-rate
calculations, not an existence or stability theorem for the decentralized equilibrium.

The absence of a positive finite constant-growth candidate does not by itself establish a
...
Human essentiality determines which feedback condition appears in the candidate
calculation. If research is Cobb--Douglas in human and automated inputs, a positive
finite candidate instead requires
$1-\phi-\eta\omega_M\omega_X/\omega_L>0$. We impose this restriction in the
baseline analysis, so the human-essential Cobb--Douglas candidate has a positive
finite rate by construction. The analytical counterfactual relaxes this restriction.
At equality, capability growth accelerates without a finite-time divergence. When
the feedback term exceeds diminishing returns, the reduced system reaches a
finite-time singularity even though $\sigma_{XL}=1$. Gross substitution between
labor and AI services is therefore not necessary for explosive growth.
This condition is weaker because only the automated-input elasticity $\omega_M$
transmits the expansion of output back into research. There is therefore a parameter
region in which the human-essential candidate has a positive finite rate while the
AI-dominated candidate does not.
...
paper's acceleration result therefore comes from recursive improvement, not from
gross substitution or capital deepening alone.
...
The conditional asymptotic calculations distinguish three roles for the production
elasticity. When $\sigma_{XL}<1$, the low-elasticity candidate leaves labor essential
...
labor becomes the bottleneck. With $\sigma_{XL}=1$, capability growth rises gradually
and reaches 2.271 percent by year 2,000. Output- and consumption-per-capita growth
then approach 0.568 percent, while the automated research share approaches one.
