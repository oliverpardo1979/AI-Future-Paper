...
simulations therefore provide counterexamples, within the fixed-share closure, to
both an immediate-takeoff reading of $\sigma_{XL}>1$ and an inference of eventual
balanced growth from a long, apparently stable transition. The wage experiments
...
constant-growth limit with $\sigma_{XL}<1$ has $g_Y=n$. If the developer's first-order
and costate conditions also hold, the necessary capability-growth rate is
$g_A=\eta n/(1-\phi+\eta)$ and the research shares decline. The fixed-share numerical
closure instead imposes $g_A=\eta n/(1-\phi)$. By contrast, $\sigma_{XL}>1$ rules out
an interior steady state whenever $A_t\to\infty$, while a negative value of
...
restrictions that characterize or rule out constant-growth limits. Its acceleration
and singularity classifications apply to the reduced closures stated in the relevant
propositions, not automatically to the fully optimizing transition. The paper does
not assign probabilities to those regimes or determine their full welfare ranking.
