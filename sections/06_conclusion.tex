...
$\sigma_{XL}>1$ and capability is unbounded, the production-labor share converges to
zero and the return to capital diverges. The household Euler equation then makes
consumption growth diverge, so no interior steady state with finite constant growth
rates exists. The qualification is important: $\sigma_{XL}>1$ alone does not exclude
a boundary path with bounded capability.
