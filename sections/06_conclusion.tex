...
gross substitutes ($\theta>1$), the automated share rises with the research wage
...
The production elasticity $\sigma$ also separates the wage response from the
...
when $\sigma>1/\alpha$. Under high population growth and a very high production
elasticity $\sigma$, the negative latter term can dominate even when the capital
term is positive. The labor-share experiments also show that the production and aggregate shares need not
move together: with $\sigma=1$, the first remains constant while the second falls as
the human-research employment share declines. By contrast, strong production
