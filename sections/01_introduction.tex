...
instead enters an acceleration regime. It also shows why a long period of moderate
growth need not establish convergence: when the production elasticity is close to
one, the transition can remain near Cobb--Douglas for centuries before the asymptotic
force becomes quantitatively important.
...
has zero per-capita output growth. At $\sigma_{XL}=1$, a positive constant-growth
path can exist under the stability and resource-feasibility restrictions. If
...
general-equilibrium paths. The numerical counterexample shows that the real wage can
fall when AI-services deepening dominates capital deepening. The aggregate labor
share can also differ from the production-labor share because it includes human
researchers. Finally, monopoly creates a static deployment distortion but also the
rents that give frontier capability a private value; incomplete appropriability
creates a distinct reason for private research to remain below the social level.
