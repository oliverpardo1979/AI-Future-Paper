...
requires $1-\phi-\eta\omega_M\upsilon>0$, where
$\upsilon\equiv\beta/(1-\alpha-\beta)$. When automated research can instead become
asymptotically dominant, the condition becomes
$1-\phi-\eta\upsilon>0$. The second condition is stricter because $\omega_M<1$. There is
...
conditional on Cobb--Douglas production. If $\sigma_{XL}>1$, capability raises the
output--capital ratio, creating a separate production-side acceleration mechanism.
Human essentiality weakens the research feedback but does not by itself restore
balanced growth.
...
labor-bottlenecked regime, a constant-share benchmark, and a regime in which the
return to capital rises with capability. Eighth, the production structure
