...
The toy model delivers six results. First, the automated share of research follows
...
semi-endogenous capability growth while human research dominates. Fourth, when
automated research dominates, a constant-growth path exists only if diminishing
returns offset the feedback between output and research. Fifth, the production CES
separates a labor-bottlenecked regime, a constant-share benchmark, and a regime in
which the return to capital rises with capability. Sixth, the production structure
