...
$1-\phi-\eta\omega_M\omega_X/\omega_L>0$. We maintain this restriction throughout
the paper. Equivalently,
...
evidence for the propositions. Section~\ref{sec:analytical-results} first derives
the analytical results. Section~\ref{sec:numerical} then describes the equilibrium
construction, boundary conditions, and numerical audit behind the figure.
...
develops the baseline model and states the analytical propositions.
Section~\ref{sec:numerical} constructs and audits the numerical equilibrium paths
after the analytical propositions have been stated.
