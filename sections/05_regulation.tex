...
A subsidy to human research or research compute, or an innovation prize contingent on
capability improvements, targets the wedge $(Q_t-q_t)F_{M,t}$. The distinction
matters for implementation: an input subsidy rewards expenditure, while a prize
rewards measured output. Either instrument can increase private research without
requiring a high markup on all current uses of AI.
...
static monopoly distortion and the research instrument restores the dynamic
incentive weakened by lower operating rents. The quantitative model will determine
whether one instrument is enough or whether this two-instrument policy is required.
...
AI-dominated acceleration is measured.
